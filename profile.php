    ...
    <head>
        <title><?php 
            ...
            while($row = $result->fetch_assoc()) {
                echo $row['username']."'s Profile - KrnlTUBE";
            }
            $statement->close();
        ?></title>
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        <div class=\"user-info\">
                            ...
                            if($_SESSION["subscribedto".$row["id"]] === false) {
                                $finalstring .= "<div><a href=\"subscribe.php?id=".$row["id"]."&u=0\"><img src=\"buttonunsub.png\"></a><h5>please do not spam click the button or you can get ban from the website</h5></div>";
                            }
                            else{
                                $finalstring .= "<div><a href=\"subscribe.php?id=".$row["id"]."&u=1\"><img src=\"buttonsub.png\"></a><h5>please do not spam click the button or you can get ban from the website</h5></div>";
                            }
                        $finalstring .= "</div>";
