...
<body>
    ...
    <div class="container-flex"> 
        <div class="col-1-2">
            ...
            <div class="card blue">
                <form method="post" action="alogin.php">
                    ...
                    <a onclick="alert('Send a message to one of our staff on Discord.')">Forgot your password?</a>
                    <div class="input-group">
                        <div></div>
                        <div class="red">
                            <?php
        ...
        <div class="col-1-2">
            ...
            <p>
           	when you create an account you have this feature:
            </p>
            <ul>
                <li>uploading</li>
                <li>liking</li>
